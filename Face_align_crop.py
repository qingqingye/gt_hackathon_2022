...
def getArgs():
    ...
    parser.add_argument('--input_path', type=str, default='faces', help='the dir your dataset of face which need to crop')
    parser.add_argument('--output_path', type=str, default='output', help='the dir the cropped faces of your dataset where to save')
